...
public class NewsOpinion extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String LOG = NewsOpinion.class.getName();
    private static final String USGS_REQUEST_URL =
            "https://content.guardianapis.com/commentisfree?api-key=803d6f2c-c20f-4e1d-a11b-97b2a2b53bca";
